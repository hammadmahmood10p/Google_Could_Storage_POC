    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    query = "SELECT refresh_date AS Day, term AS Top_Term, rank, FROM `bigquery-public-data.google_trends.top_terms` WHERE rank = 1 AND refresh_date >= DATE_SUB(CURRENT_DATE(), INTERVAL 2 WEEK) GROUP BY Day, Top_Term, rank ORDER BY Day DESC";
                    return [4 /*yield*/, bigquery.query({ query: query })];
                case 1:
                    rows = (_a.sent())[0];
                    if (rows.length === 0) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error executing BigQuery query:", error_1);
                    return [3 /*break*/, 3];
